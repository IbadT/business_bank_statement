import { CompanyDetails, FinancialAndOwners, ClientsAndPaymentGateways, Contractors, ReviewAndCheckout, TopUpsAndExpenses, StepNavigation } from "../../widgets";
...
export const BusinssBankStatementPage = () => {
